...
![Koopman lifts nonlinear state dynamics into an observable space where evolution can be linear. Source: Brunton et al.](figures/brunton_koopman.png){fig-alt="Koopman schematic showing nonlinear dynamics in state space and linear dynamics in observable space" width="82%"}
...
![](figures/diagrams-koopman_simple.svg){fig-alt="Deep Koopman architecture with encoder, linear latent dynamics, and decoder" width="82%"}
...
::: {.light-figure}
![](figures/diagrams-dssm.svg){fig-alt="Deep state-space model diagram showing input, state transition, and output projection" width="100%"}
:::
